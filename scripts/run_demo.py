...
def main():
    ...
    print("[SUCCESS] Pre-trained models found")
    ...
    try:
        ...
        print("[SUCCESS] Fusion module initialized successfully")
    except Exception as e:
        print(f"[ERROR] Error initializing fusion: {e}")
        return
    ...
    try:
        ...
        print("[SUCCESS] Created sample data")
        ...
        print(f"[ERROR] Error testing with sample data: {e}")
